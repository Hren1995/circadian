function [watershedRegions,segments,v,obj,pRest,vals] = findWatershedRegions(all_z,xx,LL,vSmooth,medianLength,pThreshold,minRest,obj,fitOnly)
    ...
    if nargin < 8 || isempty(obj)
        ...
        figure
        obj = gmixPlot(sampleFromMatrix(log(v)./log(10),numToTest),numGMM,[],200,[],true,[],[],3);
    ...
    if ~fitOnly
        ...
        %watershedValues = modeFilterData(watershedValues,modeLength);
        ...
        if length(pThreshold) == 1
            ...
            CC = largeBWConnComp(pRest > pThreshold(1) & diffValues,minRest,pRest,pThreshold(2));
        end
